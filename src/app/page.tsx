...
const translations = {
  ...
  tr: {
    ...
    cardDermoscopyTitle: "Vitiligo Cerrahisi (NCEMT)",
    cardDermoscopyDesc: "Stabil vitiligo tedavisinde ileri düzey Hücre Kültürsüz Melanosit-Keratinosit Transplantasyonu (NCEMT) ve mini greftleme tekniklerinde geniş deneyim.",
    ...
    blog1Desc: "Stabil vitiligo yamalarında melanosit transplantasyonu (NCEMT) cerrahi tedavi seçeneğine genel bakış.",
    ...
    workingHoursVal: "Cmt – Per: 10:00 – 18:00",
