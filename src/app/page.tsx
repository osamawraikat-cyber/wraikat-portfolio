            ...
            <div className="col-span-12 md:col-span-7">
              ...
              <div className="flex flex-wrap gap-2.5 mb-8">
                <span className="bg-surface-container border border-outline-variant/10 text-white px-3 py-1.5 rounded-lg text-xs font-medium">
                  🇹🇷 {lang === "ar" ? "خريج أكاديمية غولهانة العسكرية (أنقرة)" : lang === "tr" ? "Gülhane Askeri Tıp Akademisi Mezunu" : "Gülhane Military Academy Graduate (Ankara)"}
                </span>
                <span className="bg-surface-container border border-outline-variant/10 text-white px-3 py-1.5 rounded-lg text-xs font-medium">
